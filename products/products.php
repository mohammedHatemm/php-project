      ...
      <div class="container">
        <div class="text-center py-5">
          ...
          <p class="lead text-light">
            Discover our premium selection of beverages and treats
          </p>
        </div>
      </div>
    </header>
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="filter-buttons mb-4">
              ...
              <button type="button" class="btn btn-filter" data-filter="hot">
                Hot Drinks
              </button>
              <button type="button" class="btn btn-filter" data-filter="cold">
                Cold Drinks
              </button>
              <button type="button" class="btn btn-filter" data-filter="dessert">
                Desserts
              </button>
            </div>
...
style="width: 100%;"
      ...
      <div class="cart-sidebar-overlay">
        <div class="cart-header">
          <h4>
            ...
            Your Cart
            <span id="cart-count-overlay" class="badge bg-primary ms-2">0</span>
          </h4>
        ...
        <div class="cart-body">
          <div id="cart-items-overlay" class="cart-items">
            <!-- Cart items will be added here dynamically -->
          </div>
          <div class="cart-total">
            <h5>Total: <span id="cart-total-overlay">0</span> $</h5>
          </div>
          <button class="btn btn-primary w-100" onclick="showCheckoutMessage()">
            Checkout
    ...
    <div class="checkout-message" id="checkoutMessage">
      <div class="message-content">
        ...
        <button class="btn btn-primary" onclick="hideCheckoutMessage()">
          Continue Shopping
        </button>
      </div>
    </div>
